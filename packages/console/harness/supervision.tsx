...
const respuestas: Record<string, unknown> = {
  '/actividad': {
    operador: { id: 2, nombre: 'Héctor', email: 'hector@falconseguridadtotal.com' }, periodo: { desde: hace(10080), hasta: hace(0) },
    acciones: [
      { id: 9, creadoEn: hace(12), tipo: 'cierre', detalle: 'Falsa alarma tras 4 min 10 s en atención: Mascota u objeto en movimiento', alarmaId: 51, codigo: 'E140', descripcion: 'Alarma en zona 3', numeroCuenta: '7048', prefijo: 'AL', clienteNombre: 'COMERCIAL GALIVEN' },
      { id: 8, creadoEn: hace(14), tipo: 'llamada', detalle: 'Llamada a Luis Pérez (0414-1234567): Atendió, palabra clave correcta', alarmaId: 51, codigo: 'E140', descripcion: 'Alarma en zona 3', numeroCuenta: '7048', prefijo: 'AL', clienteNombre: 'COMERCIAL GALIVEN' },
      { id: 7, creadoEn: hace(16), tipo: 'toma', detalle: 'Tomada tras 45 s de espera', alarmaId: 51, codigo: 'E140', descripcion: 'Alarma en zona 3', numeroCuenta: '7048', prefijo: 'AL', clienteNombre: 'COMERCIAL GALIVEN' },
    ],
    sesiones: [{ id: 3, ingresoEn: hace(180), ultimaActividadEn: hace(2), ip: '::ffff:38.51.121.28', agente: null }],
    hombreMuerto: [{ id: 30, ocurridoEn: hace(95), descripcion: 'HOMBRE MUERTO: hector@falconseguridadtotal.com no confirmó presencia en la consola' }],
  },
  '/supervision': {
    periodo: { desde: hace(10080), hasta: hace(0) },
    operadores: [
      { id: 2, nombre: 'Héctor', email: 'hector@falconseguridadtotal.com', rol: 'operador', activo: true, tomadas: 14, cerradas: 12, reaccionMediaSeg: 48, reaccionMaxSeg: 410, atencionMediaSeg: 262, desenlaces: { resuelta: 7, falsa_alarma: 4, escalada: 1 }, motivos: [], llamadas: 19, notas: 6, pasos: 21, devoluciones: 1, hombreMuerto: 1, sesiones: 5, horasEnServicio: 31.4, ultimaActividadEn: hace(2), enServicio: true },
      { id: 3, nombre: 'Brayan', email: 'brayan@falconseguridadtotal.com', rol: 'operador', activo: true, tomadas: 9, cerradas: 9, reaccionMediaSeg: 150, reaccionMaxSeg: 900, atencionMediaSeg: 180, desenlaces: { resuelta: 6, falsa_alarma: 3, escalada: 0 }, motivos: [], llamadas: 0, notas: 2, pasos: 4, devoluciones: 0, hombreMuerto: 0, sesiones: 4, horasEnServicio: 26.0, ultimaActividadEn: hace(220), enServicio: false },
    ...
    alertas: [
      { tipo: 'sin_tomar', alarmaId: 60, prioridad: 1, texto: 'E120 Pánico (AL-7075) lleva 3 min sin tomar' },
      { tipo: 'cierre_sin_llamada', alarmaId: 58, texto: 'Brayan cerró E130 Robo sin registrar ninguna llamada' },
      { tipo: 'sin_actividad', usuarioId: 3, texto: 'Brayan no toca la consola hace 220 min' },
    ],
  },
};
